        ...
        <div className="bg-white p-10 rounded-none shadow-2xl shadow-slate-200/60 border border-slate-100">
          <div className="mb-0 text-center">
            ...
            <p className="text-slate-500 mt-2 text-sm font-medium">
              Join our marketplace of skilled professionals.
            </p>
          </div>
          ...
          >
            ...
            <div className="space-y-5">
              <div className="relative group">
                ...
                />
                <User
                  className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[var(--color-text)] transition-colors"
                  size={18}
                />
              </div>
            ...
            <p className="text-center text-xs font-bold text-slate-400 pt-6">
              ...
              <Link
                to="/login"
                className="text-[#0a2e5c] font-red hover:underline underline-offset-4"
              >
                SIGN IN
              </Link>
            </p>
